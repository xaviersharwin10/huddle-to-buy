...
async function main() {
  ...
  const payTokenAddr    = process.env.PAY_TOKEN_ADDRESS ?? "0x036CbD53842c5426634e7929541eC2318f3dCF7e";

  if (!pk || !coalitionAddr) {
    console.error("PRIVATE_KEY and COALITION_ADDRESS are required");
    process.exit(1);
  }
